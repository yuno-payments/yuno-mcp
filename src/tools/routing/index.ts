...
import {
    ...
    YunoRoutingLogin,
    YunoRoutingLoginResponse, YunoRoutingUpdateWorkflow,
} from "./types";
...
export const routingCreateTool = {
    ...
    handler:
        <TType extends "object" | "text">({ yunoClient, type }: HandlerContext<TType>) =>
            async (data: YunoRoutingCreateSchema): Promise<Output<TType, any>> => {
...
export const routingRetrieveTool = {
    ...
    handler:
        <TType extends "object" | "text">({ yunoClient, type }: HandlerContext<TType>) =>
            async (data: { versionCode: string }): Promise<Output<TType, any>> => {
...
export const routingUpdateTool = {
    ...
    handler:
        <TType extends "object" | "text">({ yunoClient, type }: HandlerContext<TType>) =>
            async (data: YunoRoutingUpdateWorkflow): Promise<Output<TType, any>> => {
   ;
...
export const routingLogOutTool = {
    ...
    handler:
        <TType extends "object" | "text">({ yunoClient, type }: HandlerContext<TType>) =>
            async (): Promise<Output<TType, any>> => {
                const result = await yunoClient.routing.logout();
