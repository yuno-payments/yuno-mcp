...
export class YunoClient {
  ...
  routing = {
    ...
    create: async (body: YunoRoutingCreateSchema) => {
      ...
      return this.requestDashboard<any>(`/api/smart-routing/create-workflow/${encodeURIComponent(this.accountCode)}`, {
        method: "POST",
        body: JSON.stringify(body),
      });
    },
    ...
    update: async (data: YunoRoutingUpdateWorkflow)=> {
      ...
      return this.requestDashboard<any>(`/api/smart-routing/update-workflow/${encodeURIComponent(this.accountCode)}`, {
        method: "PUT",
    ...
    post: async (versionCode: string) =>{
      ...
      return this.requestDashboard(`/api/smart-routing/publish-version/${encodeURIComponent(this.accountCode)}/${encodeURIComponent(versionCode)}`, {
        method: "POST",
      })
    },
    ...
    retrieve: async (versionCode: string) => {
      ...
      return this.requestDashboard<any>(`/api/smart-routing/workflow-version/${encodeURIComponent(this.accountCode)}/${encodeURIComponent(versionCode)}`, {
        method: "GET",
      });
    },
