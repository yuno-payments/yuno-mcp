import z from "zod";
import { addressSchema, amountSchema, documentSchema, metadataSchema, phoneSchema, YunoAmount, YunoMetadata } from "../shared/types";
...
export const paymentLinkCancelSchema = z.object({
  description: z.string().optional().describe("Reason for the cancellation"),
  reason: z.enum(["DUPLICATE", "FRAUDULENT", "REQUESTED_BY_CUSTOMER", "OTHER"]).optional().describe("Reason for the cancellation. Values could be DUPLICATE, FRAUDULENT, REQUESTED_BY_CUSTOMER, and OTHER."),
