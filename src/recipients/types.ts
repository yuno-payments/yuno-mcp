...
import { addressSchema, documentSchema, metadataSchema, phoneSchema } from "../shared/types";
...
export const recipientCreateSchema = z.object({
  ...
  entity_type: z.enum(["GOVERNMENTAL", "PUBLIC", "NON_PROFIT", "PRIVATE"]).optional().describe("The Beneficiary's type of organization. GOVERNMENTAL, PUBLIC, NON_PROFIT, PRIVATE"),
  ...
  }).optional().describe("Withdrawal methods for the recipient"),
...
export const recipientUpdateSchema = z.object({
  ...
  }).optional().describe("Providers for the recipient"))
});
