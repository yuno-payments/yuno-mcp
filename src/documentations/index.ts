...
import { DocumentationReadSchema, documentationReadSchema } from "./types";
...
const documentationReadTool: Tool = {
  method: "documentationRead",
  description: "Read a documentation",
  schema: documentationReadSchema,
  handler: async (_, { documentation_type }: DocumentationReadSchema) => {
    try {
      ...
      if (documentation_type === "enrollPaymentMethod") {
        ...
        return {
          content: [{ type: "text", text: await enrollPaymentMethodDocsText }],
        };
      }
      ...
      if (documentation_type === "retrievePaymentMethod") {
        ...
        return {
          content: [{ type: "text", text: await retrievePaymentMethodDocsText }],
        };
      }
      ...
      if (documentation_type === "unenrollPaymentMethod") {
        ...
        return {
          content: [{ type: "text", text: await unenrollPaymentMethodDocsText }],
        };
      }
      ...
      if (documentation_type === "retrievePaymentLink") {
        ...
        return {
          content: [{ type: "text", text: retrievePaymentLinkDocsText }],
        };
      }
      ...
      if (documentation_type === "createSubscription") {
        ...
        return {
          content: [{ type: "text", text: createSubscriptionDocsText }],
        };
      }
      ...
      if (documentation_type === "retrieveSubscription") {
        ...
        return {
          content: [{ type: "text", text: retrieveSubscriptionDocsText }],
        };
      }
      ...
      if (documentation_type === "resumeSubscription") {
        ...
        return {
          content: [{ type: "text", text: resumeSubscriptionDocsText }],
        };
      }
      ...
      if (documentation_type === "updateSubscription") {
        ...
        return {
          content: [{ type: "text", text: updateSubscriptionDocsText }],
        };
      }
      ...
      if (documentation_type === "cancelSubscription") {
        ...
        return {
          content: [{ type: "text", text: cancelSubscriptionDocsText }],
        };
      }
      ...
      if (documentation_type === "createRecipientOnboarding") {
        ...
        return {
          content: [{ type: "text", text: createRecipientOnboardingDocsText }],
        };
      }
      ...
      if (documentation_type === "createInstallmentPlan") {
        ...
        return {
          content: [{ type: "text", text: createInstallmentPlanDocsText }],
        };
      }
      ...
      if (documentation_type === "retrieveInstallmentPlan") {
        ...
        return {
          content: [{ type: "text", text: retrieveInstallmentPlanDocsText }],
        };
      }
      ...
      if (documentation_type === "retrieveAllInstallmentPlans") {
        ...
        return {
          content: [{ type: "text", text: retrieveAllInstallmentPlansDocsText }],
        };
      }
      ...
      if (documentation_type === "updateInstallmentPlan") {
        ...
        return {
          content: [{ type: "text", text: updateInstallmentPlanDocsText }],
        };
      }
      ...
      if (documentation_type === "deleteInstallmentPlan") {
        ...
        return {
          content: [{ type: "text", text: deleteInstallmentPlanDocsText }],
        };
      }
      ...
      if (documentation_type === "guides") {
        ...
        return {
          content: [
            { type: "text", text: skdsDocsText },
            { type: "text", text: countryCoverageDocsText },
          ],
        };
      }
...
export const documentationTools: Tool[] = [documentationReadTool];
