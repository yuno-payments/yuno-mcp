...
export const customerPayerSchema = z.object({
  ...
  merchant_customer_created_at: z.string().min(27).max(27).optional().describe("Customer´s registration date on the merchants platform (ISO 8601)").optional(),
  ...
  device_fingerprints: z.array(z.object({
