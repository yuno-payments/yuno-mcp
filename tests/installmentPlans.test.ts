...
} from '../src/installmentPlans/types';
import z from 'zod';
...
describe('installmentPlanCreateTool', () => {
  it('should execute the main action, call the client, and return the expected result', async () => {
    ...
    const result = await installmentPlanCreateTool.handler(
  ...
  it('should handle execution with all optional fields, nested objects, and empty optional arrays/objects', async () => {
    ...
    const input = {
      ...
      installments_plan: [
        { installment: 6, rate: 2.0, type: 'MERCHANT_INSTALLMENTS' },
      ],
      country_code: 'US',
      brand: [],
      issuer: 'Bank',
...
describe('installmentPlanUpdateTool', () => {
  it('should execute the main action, call the client, and return the expected result', async () => {
    ...
    const result = await installmentPlanUpdateTool.handler(
      mockYunoClient as any,
      input
    );
  ...
  it('should handle execution with all optional fields, nested objects, and empty optional arrays/objects', async () => {
    ...
    const input = {
      ...
      name: 'Full Update',
      installments_plan: [
        { installment: 12, rate: 3.0, type: 'ISSUER_INSTALLMENTS' },
      ],
      brand: [],
      issuer: 'Bank',
      iin: [],
...
describe('installmentPlanRetrieveTool', () => {
  ...
  it('should execute the main action, call the client, and return the expected result', async () => {
    ...
    const result = await installmentPlanRetrieveTool.handler(
      mockYunoClient as any,
      input
    );
...
describe('installmentPlanDeleteTool', () => {
  ...
  it('should execute the main action, call the client, and return the expected result', async () => {
    ...
    const input = { planId: 'plan_123' };
    const result = await installmentPlanDeleteTool.handler(
      mockYunoClient as any,
      input
    );
