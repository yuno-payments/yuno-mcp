...
} from '../src/paymentLinks';
import {
  paymentLinkCreateSchema,
  paymentLinkCancelSchema,
...
describe('paymentLinkCreateTool', () => {
  it('should execute the main action, call the client, and return the expected result', async () => {
    ...
    const result = await paymentLinkCreateTool.handler(
...
describe('paymentLinkRetrieveTool', () => {
  ...
  it('should execute the main action, call the client, and return the expected result', async () => {
    ...
    const result = await paymentLinkRetrieveTool.handler(
      mockYunoClient as any,
      input
    );
...
describe('paymentLinkCancelTool', () => {
  ...
  it('should execute the main action, call the client, and return the expected result', async () => {
    ...
    const result = await paymentLinkCancelTool.handler(
      mockYunoClient as any,
      input
    );
